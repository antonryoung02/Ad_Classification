...
from modeling.Augment import DefaultsTransformation, AugmentedImageFolder
from torchvision.transforms import v2
from torchvision.transforms.functional import to_pil_image

def simulate_data_augmentation_method(augmentation_class, invert_normalization=False):
    ...
    train_data_folder = AugmentedImageFolder(root=input_dir, transform=train_transform, augmentation=augmentation_class)
