...
class SimpleCNN(nn.Module):
    ...
    def __init__(self, network, input_shape=(224,224)):
        super(SimpleCNN, self).__init__()
        self.input_shape = input_shape
        self.network = network
        #Adds fc layer of correct dimensions
        self.network.add_module("fc", nn.Linear(self.find_fc_layer_shape(), 32))
        self.network.add_module("fc2", nn.Linear(32,1))
